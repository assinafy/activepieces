...
const REPO_LICENSE = readFileSync(
  join(pieceDir, '.activepieces', 'LICENSE'),
  'utf-8'
);
...
function workspaceRoot(inputPath) {
  ...
  while (dir.startsWith(pieceDir) && dir !== pieceDir) {
