...
describe('translations', () => {
  ...
  test('translation.json lists every user-facing string of the piece', async () => {
    ...
    const generated = Object.fromEntries(
      strings.map((text) => [text.slice(0, 512), text])
    );
    await expect(JSON.stringify(generated, null, 2)).toMatchFileSnapshot(
